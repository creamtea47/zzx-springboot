...
public class FwResult<T> implements Serializable {
  ...
  public static <T> FwResult<T> ok() {
    return restResult((T) null, 200, true, "操作成功");
  }

  public static <T> FwResult<T> okMsg(String msg) {
    return restResult((T) null, 200, true, msg);
  }
